        ...
        <div class="wrapper">
            ...
            <?php
                ...
                if(isset($_GET['id']))
                    ...
                    $id = $_GET['id'];
                    // create sql query to get all all the details.
...
if(isset($_POST['submit']))
{
    ...
    if(isset($_FILES['image']['name']))
    {
        ...
        if($image_name !="")
        {
            ...
            // B. Remove the image and image if availabe
            if($current_image !="")
            {
                ...
                if($remove ==false)
                {
                    $_SESSION['failed-remove'] = "<div class='error'>Failed to remove the message</div>";
                    header('location:' . SITEURL . 'admin/manage-category.php');
                    die(); //stop process
                }
