...
<!-- Categories Section Starts Here -->
    <section class="categories">
        <div class="container">
            ...
            // to count the row to check whether the category is available or not.
            ...
            if($count>0)
            {
                ...
                while($row=mysqli_fetch_assoc($res))
                {
                    ...
                    ?>
                     <a href="<?php echo SITEURL;?>categories.php?category_id=<?php echo $id; ?>">
                    ...
                    ?>
                        <div class="clearfix"></div>
                            ...
                            <p class="text-center main-text">
                                <a href="#" style="color: #3B3B98; font-weight: bold; font-family: Verdana, Geneva, Tahoma, sans-serif;">See All Foods</a>
                            </p>
                        </section>
